var provider = {
  ...
  countries: [
    ...
    'Бруней Даруссалам',
    "Бряг на слоновата кост (Кот д'Ивоар),",
    'Буве',
    'Буркина Фасо',
    'Бурунди',
    'Бутан',
  ...
  entrance_names: ['вх. А', 'вх. Б', 'вх. В', 'вх. Г', 'вх. Д', 'вх. E'],

  street_formats: ['{{street_prefix}} {{full_name}}'],

  address1_formats: ['{{street}} {{building_number}}'],
