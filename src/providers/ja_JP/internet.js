var provider = {
  top_level_domains: ['co.jp', 'com', 'ne.jp', 'net'],

  free_email_domains: ['gmail.com', 'yahoo.co.jp', 'hotmail.com'],

  email_formats: ['{{word}}@{{domain}}', '{{word}}@{{free_email_domain}}'],

  url_formats: ['http://www.{{domain}}/', 'http://{{domain}}/'],

  domain_formats: ['{{word}}.{{top_level_domain}}'],
