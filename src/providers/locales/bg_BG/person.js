...
var provider = {
  ...
  name_formats: ['г-жа {{female_full_name}}', 'г-н {{male_full_name}}'],
  ...
  female_full_name_formats: ['{{female_first_name}} {{female_last_name}}'],

  male_full_name_formats: ['{{male_first_name}} {{male_last_name}}'],
