...
var provider = {
  ...
  username_formats: ['{{last_name}}{{first_name}}'],

  name_formats: ['{{full_name}}{{name_prefix}}'],

  full_name_formats: ['{{last_name}}{{first_name}}'],

  company_name_formats: ['{{last_name}}{{company_suffix}}'],
